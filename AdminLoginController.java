...
public class AdminLoginController implements Initializable {
   ...
   @FXML
    ...
    String sql = "Select * from admin where name = ? and password = MD5(?) ";
        try {
            ...
            if(rs.next()){ 
                //String person = txt_username.getText();
                
                JOptionPane.showMessageDialog(null, "Username And Password is Corect");
                btn_login.getScene().getWindow().hide();
                FXMLLoader loader = new FXMLLoader();
                loader.setLocation(getClass().getResource("/FXML/Admin_Main.fxml"));
