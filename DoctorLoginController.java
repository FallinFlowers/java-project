...
public class DoctorLoginController implements Initializable {
    ...
    String sql = "Select * from doctors where login = MD5(?) and password = MD5(?) ";
        try {
            ...
            if(rs.next()){ 
                ...
                loader.setLocation(getClass().getResource("/FXML/DoctorMain.fxml"));
                Parent tableViewParent = loader.load();
                Scene tableViewScene = new Scene(tableViewParent);
                DoctorMainController controller = loader.getController();
